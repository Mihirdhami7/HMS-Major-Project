    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.data?.debug_otp) {
          ...
          console.log("%c OTP CODE: " + result.data.debug_otp, "background: #222; color: #bada55; font-size: 16px; padding: 10px;");
        }
      } else {
    ...
    <div className="min-h-screen flex items-center justify-center bg-green-100">
      <div className="flex bg-green-50 shadow-lg rounded-lg overflow-hidden w-3/4 max-h-[80vh] mt-16">
        <div className="w-1/2 bg-blue-500 flex items-center justify-center p-10">
          <img src="public/images/account.png" alt="Sign Up Illustration" className="w-full h-auto" />
        </div>
