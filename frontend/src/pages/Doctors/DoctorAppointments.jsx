...
import { getDoctorAppointments, getUserProfile } from "../../services/userService";
...
function DoctorAppointments() {
  ...
  const fetchAppointmentsData = async () => {
    try {
      ...
      const appointmentsResult = await getDoctorAppointments(token);
      if (!appointmentsResult.success) {
        setError(appointmentsResult.error || "Failed to fetch appointments");
        return;
      }
      ...
      <div className="flex flex-col flex-1 p-8 overflow-auto mt-16">
        ...
        {userData?.hospitalName && (
          <div className="mb-4 p-4 bg-white rounded-lg shadow-lg flex items-center border-l-4 border-blue-500">
            <img
              src={
                userData.hospitalName === "Zydus"
                  ? "/public/images/zydus.png"
                  : userData.hospitalName === "Iris"
                  ? "/public/images/iris.png"
                  : "/public/images/default-hospital.png"
              }
              alt={`${userData.hospitalName} Hospital`}
            ...
            />
            <div>
              <h3 className="text-lg font-bold text-blue-700">{userData.hospitalName} Hospital</h3>
